...
def button():
	BUTTON=[[InlineKeyboardButton(text="??????? Sahibim ",url="t.me/SakirBey1")]]
	BUTTON+=[[InlineKeyboardButton(text="?? Open Source ??",url="https://instagram.com/developer.rat")]]
